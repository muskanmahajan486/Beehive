...
/**
 * This is the JSON version of the list of commands. It differs from the XML version
...
public class ControllerCommandListingJSON {

	private List<ControllerCommandDTO> commands = new ArrayList<ControllerCommandDTO>();

	public ControllerCommandListingJSON() {
	}

	public ControllerCommandListingJSON(List<ControllerCommandDTO> commands) {
